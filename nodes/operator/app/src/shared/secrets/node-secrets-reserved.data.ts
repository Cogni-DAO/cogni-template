...
export const SUBSTRATE_RESERVED_KEYS: ReadonlySet<string> = new Set<string>([
  ...
  "LITELLM_VIRTUAL_KEY", // per-node budgeted LiteLLM credential
...
const EXTERNAL_WORKLOAD_SECRET_KEYS: ReadonlySet<string> = new Set<string>([
  "AUTH_SECRET",
  "DATABASE_URL",
  "DATABASE_SERVICE_URL",
  "DOLTGRES_URL",
...
/** Fleet/custody/admin secrets that must never cross into external compute. */
export const EXTERNAL_WORKLOAD_DENIED_KEYS: ReadonlySet<string> =
  new Set<string>([
    "LITELLM_MASTER_KEY",
    "OPENROUTER_API_KEY",
    "GH_REVIEW_APP_ID",
...
export function isExternalWorkloadSecretKey(key: string): boolean {
  return (
    ...
    !EXTERNAL_WORKLOAD_DENIED_KEYS.has(key)
  );
}
