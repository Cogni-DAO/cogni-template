 ...
 * Invariants: Config created in useEffect (browser-only); stable across theme changes; nested RainbowKitThemeProvider isolates theme from WagmiProvider; triggers session refresh after SIWE.
 * Side-effects: IO (session update after SIWE verification)
 * Notes: Nested RainbowKitThemeProvider isolates theme changes from WagmiProvider to prevent React Query Hydrate warnings. Session refresh ensures immediate navigation after auth.
