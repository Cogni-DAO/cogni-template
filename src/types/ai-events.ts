 ...
 * Scope: Defines AiEvent union used by ports and features. Does NOT implement functions.
 * Invariants:
 ...
 * Links: graph-executor.port.ts, features/ai/types.ts, GRAPH_EXECUTION.md
 * @public
 */
