...
gh secret set APP_DB_USER --env $ENV --body "cogni_app_${ENV}"
...
| `APP_DB_USER`             | App DB user               | `cogni_app_preview` or `cogni_app_production`           |
...
| `DATABASE_URL`            | Full connection string    | Constructed from above                                  |
