...
- **Env/Config keys:** `DB_HOST`, `POSTGRES_USER`, `POSTGRES_PASSWORD`, `APP_DB_NAME`, `APP_DB_USER`, `APP_DB_PASSWORD`, `APP_DB_SERVICE_PASSWORD`, `LITELLM_DB_NAME` (note: these are provisioning vars, not runtime app vars)
