 ...
 * Invariants:
 * - RECEIPT_APPEND_ONLY: insertIngestionReceipts never updates existing rows; semantic conflicts throw.
...
/** Outcome of append-only receipt insertion after semantic duplicate checks. */
