...
/**
 * Module: `@cogni/langgraph-graphs/graphs/ponderer/server`
 * Purpose: LangGraph dev server entrypoint for ponderer graph.
...
export const ponderer = createServerEntrypoint(
  PONDERER_GRAPH_NAME,
  createPondererGraph,
  { llm }
);
