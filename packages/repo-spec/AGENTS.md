...
- **Exports:**
  ...
  - `extractNodeServices(spec)` — Provider-neutral app-tier service declaration with optional HTTP readiness path; omission resolves to the legacy one-public-app default
